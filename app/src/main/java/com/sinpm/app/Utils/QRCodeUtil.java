...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int width, int height,String version){
        return createQRCodeBitmap(content+"&v="+version, width, height, "UTF-8", "L", "0", Color.BLACK, Color.WHITE);
    }
